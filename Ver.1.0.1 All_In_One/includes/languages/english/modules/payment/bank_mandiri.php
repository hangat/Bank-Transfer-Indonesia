...
define('MODULE_PAYMENT_BANK_MANDIRI_TEXT_EMAIL_FOOTER', 
  ...
  '\nAccount No.:  ' . MODULE_PAYMENT_BANK_MANDIRI_ACCNUM .
  '\nBSB Number:   ' . MODULE_PAYMENT_BANK_MANDIRI_BSB . 
  '\nAccount Name: ' . MODULE_PAYMENT_BANK_MANDIRI_ACCNAM . 
  '\nBank Name:    ' . MODULE_PAYMENT_BANK_MANDIRI_BANKNAM .
  '\nSwift Code:   ' . MODULE_PAYMENT_BANK_MANDIRI_SWIFT . 
  '\nReference:    '  . $ln .'-' . $id . '-%s' .
  '\n\nSend Money Orders To:    ' . MODULE_PAYMENT_BANK_MANDIRI_ADDRESS . 
  '\nMoney Orders Payable To:   ' . MODULE_PAYMENT_BANK_MANDIRI_PAYABLE .
...
define('MODULE_PAYMENT_BANK_MANDIRI_TEXT_DESCRIPTION', 
  ...
  '<br>Account No.:  ' . MODULE_PAYMENT_BANK_MANDIRI_ACCNUM .
  '<br>Account Name: ' . MODULE_PAYMENT_BANK_MANDIRI_ACCNAM . 
