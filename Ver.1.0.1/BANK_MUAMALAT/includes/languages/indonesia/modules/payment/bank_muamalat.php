...
define('MODULE_PAYMENT_BANK_MUAMALAT_TEXT_EMAIL_FOOTER', 
  ...
  '\nNo. Rekening:  ' . MODULE_PAYMENT_BANK_MUAMALAT_ACCNUM .
  '\nBSB Number:   ' . MODULE_PAYMENT_BANK_MUAMALAT_BSB . 
  '\nNama Akun Bank: ' . MODULE_PAYMENT_BANK_MUAMALAT_ACCNAM . 
  '\nNama Bank:    ' . MODULE_PAYMENT_BANK_MUAMALAT_BANKNAM .
  '\nKode Bank:   ' . MODULE_PAYMENT_BANK_MUAMALAT_SWIFT . 
  '\nReferensi:    '  . $ln .'-' . $id . '-%s' .
  '\n\nKirim Uang untuk Pesanan:    ' . MODULE_PAYMENT_BANK_MUAMALAT_ADDRESS . 
  '\nPembayaran untuk pesanan:   ' . MODULE_PAYMENT_BANK_MUAMALAT_PAYABLE .
...
define('MODULE_PAYMENT_BANK_MUAMALAT_TEXT_DESCRIPTION', 
  ...
  '<br>No. Rekening:  ' . MODULE_PAYMENT_BANK_MUAMALAT_ACCNUM .
  '<br>Nama Akun Bank: ' . MODULE_PAYMENT_BANK_MUAMALAT_ACCNAM . 
